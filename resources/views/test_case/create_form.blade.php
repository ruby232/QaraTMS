<div id="test_case_editor">
    ...
    <div class="d-flex justify-content-between border-bottom mt-2 pb-2 mb-2">
        ...
        <div>
            <button href="button" class="btn btn-sm btn-danger" onclick="closeTestCaseEditor()">
                ...
                <div class="mb-3 d-flex justify-content-start border p-3 bg-light">
                    ...
                    <div class="mx-4">
                        ...
                        <select id="tce_priority_select" name="priority" class="form-select border-secondary">
                            <option value="{{\App\Enums\CasePriority::NORMAL}}" selected>{{__('Normal')}}</option>
                            <option value="{{\App\Enums\CasePriority::HIGH}}">{{__('High')}}</option>
                            <option value="{{\App\Enums\CasePriority::LOW}}">{{__('Low')}}</option>
                        </select>
                    </div>

                    <div>
                        <label class="form-label"><b>{{__('Type')}}</b> <i class="bi bi-person"></i> | <i
                                    class="bi bi-robot"></i></label>
                        <select name="automated" class="form-select border-secondary" id="tce_automated_select">
                            <option value="0" selected>{{__('Manual')}}</option>
                            <option value="1">{{__('Automated')}}</option>
                        </select>
                    </div>
    ...
    <div id="test_case_editor_footer" class="col-5 d-flex justify-content-between border-top pt-2">
        ...
        <div class="col d-flex justify-content-end pe-3">
            ...
            <button id="tce_save_btn" type="button" class="btn btn-outline-info me-3" onclick="createTestCase(true)">
